! function(e) {
    ...
    window.onpageshow = function(e) {
        ...
        }, 1e3), e(".typed-subtitle").length && e(".h-subtitle p").length > 1 && e(".typed-subtitle").each(function() {
            e(this).typed({
    ...
    if (a < 783 && e(".section.started").css({
        ...
        t.on("slideChange", function() {
            var a = t.realIndex,
                n = t.slides.length;
            e(".started-carousel .swiper-slide").removeClass("first"), e(".started-carousel .swiper-slide").each(function(n, t) {
    ...
    e(".animated-button span").each(function(a) {
        var n = e(this).text().split(""),
            t = e(this);
        t.empty(), e.each(n, function(e, a) {
            t.append("<em>" + a + "</em>")
        })
    }), e("header .top-menu").on("click", "a", function() {
        var a = e(this).attr("href");
        if (0 == a.indexOf("#section-")) e("body").hasClass("home") || (location.href = "/" + a), e("body, html").animate({
            scrollTop: e(a).offset().top - 115
        }, 400), e("header").hasClass("active") && e(".menu-btn").trigger("click");
        else {
            var n = e(".preloader");
    ...
    i.length && i.append('<div class="slice"><div class="bar"></div><div class="fill"></div></div>'), e(window).resize(function() {
        var a = e(window).width(),
            n = e(window).height();
